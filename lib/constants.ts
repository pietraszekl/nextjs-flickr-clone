...
export const FLICKR_PHOTOS_PUBLIC = `https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=${process.env.FLICKR_API_KEY}&extras=date_taken&nojsoncallback=1&format=json&&per_page=${process.env.ITEMS_PER_PAGE}`;
